...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <a class="flex justify-center pt-8 sm:pt-0" href="https://coex.com.co/" target="_blank">
        <div class="flex flex-row justify-center items-center">
          <figure>
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQz-TWwnsrmuVXD7HkAEMsrhdaH-tqV6a--DY9t3Cs&s" alt="">
        </figure>
        <p class="font-bold text-4xl">COEX</p>
        </div>
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the <a href="https://nuxtjs.org" target="_blank"
            class="button--doc text-green-500 hover:underline">Nuxt Documentation</a>, whether you are new or have
